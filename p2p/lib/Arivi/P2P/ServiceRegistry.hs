...
mkP2PEnv config = do
    ...
    P2PEnv <$> mkNodeEndpoint nc mkHandlers networkEnv <*> mkRpcEnv <*> mkPubSub <*> mkKademlia nc (Config.sbound config) (Config.pingThreshold config) (Config.kademliaConcurrencyFactor config) <*> createStatsdClient "statsdIP" 8080 "statsdPrefix" <*> mkPRTEnv
